...
# do
# 	# mummer MEM
# 	# /usr/bin/time -l mummer -maxmatch -l $k -b  $genome1 $genome2 > tmp.tsv 2> runtime.txt
# 	# python genome_mapping_metrics.py tmp.tsv runtime.txt --refs $genome2
# 	# # mummer MUM
# 	# /usr/bin/time -l mummer -l $k -mum -b $genome1 $genome2 > tmp.tsv 2> runtime.txt
# 	# python genome_mapping_metrics.py tmp.tsv runtime.txt --refs $genome2
# done
